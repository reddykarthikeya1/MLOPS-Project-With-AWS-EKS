...
MLFLOW_TRACKING_URI = "https://dagshub.com/reddykarthikeya1/MLOPS-Project-With-AWS-EKS.mlflow"
dagshub.init(repo_owner="reddykarthikeya1", repo_name="MLOPS-Project-With-AWS-EKS.mlflow", mlflow=True)
